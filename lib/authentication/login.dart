...
import 'package:my_app/authentication/signup.dart';
import 'package:my_app/JsonModels/user.dart';
import 'package:my_app/SQlite/sqlite.dart';
  ...
  login() async {
    ...
    if (response == true) {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => const MyHomePage(title: 'Latihan Screen',)));
    } else {
